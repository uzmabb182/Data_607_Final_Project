...
```{r}
census_df <- select(census_df, county, population, median_age, household_income, per_capita_income, poverty_count)
...
### Reading the raw NJ diabetes data for the year 2012 from GitHub
