...
```{r}
new_df <- select(new_df, name, population, median_age, household_income, per_capita_income, poverty_count, unemployment_count, bachelor_degree_or_higher_2015_19)
...
```{r}
model <- lm(bachelor_degree_or_higher_2015_19 ~ population + median_age + household_income + per_capita_income + poverty_count + unemployment_count, data = new_df)
summary(model)
```
...
```{r}
sigma(model)/mean(new_df$bachelor_degree_or_higher_2015_19)
```
...
ggscatter(new_df, x = "bachelor_degree_or_higher_2015_19", y = "poverty_count", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "bachelor_degree_or_higher_2015_19", ylab = "poverty_count", col = "red")
```


```{r}

ggscatter(new_df, x = "bachelor_degree_or_higher_2015_19", y = "population", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "bachelor_degree_or_higher_2015_19", ylab = "population", col = "blue")
```